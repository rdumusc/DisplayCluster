...
common_package(Qt5Declarative   QUIET)
if(NOT Qt5Declarative_FOUND AND NOT QT5DECLARATIVE_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Qt5Declarative")
endif()
...
common_package(Qt5Svg   QUIET)
if(NOT Qt5Svg_FOUND AND NOT QT5SVG_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Qt5Svg")
endif()
common_package(Qt5WebKitWidgets   QUIET)
if(NOT Qt5WebKitWidgets_FOUND AND NOT QT5WEBKITWIDGETS_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Qt5WebKitWidgets")
endif()
...
common_package(Qt5Xml   QUIET)
if(NOT Qt5Xml_FOUND AND NOT QT5XML_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Qt5Xml")
endif()
common_package(Qt5XmlPatterns   QUIET)
if(NOT Qt5XmlPatterns_FOUND AND NOT QT5XMLPATTERNS_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} Qt5XmlPatterns")
endif()
