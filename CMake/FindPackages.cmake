...
common_package(Qt4 4.6  REQUIRED COMPONENTS QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit)
...
if(LibJpegTurbo_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND DISPLAYCLUSTER_DEPENDENT_LIBRARIES LibJpegTurbo)
  endif()
...
set(DISPLAYCLUSTER_DEPENDS Boost;Deflect;FCGI;FFMPEG;LibJpegTurbo;MPI;OpenGL;Qt4;Poppler;TUIO;OpenMP)
