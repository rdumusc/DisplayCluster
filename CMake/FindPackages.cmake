...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Deflect 0.4)
  if((NOT Deflect_FOUND) AND (NOT DEFLECT_FOUND))
    pkg_check_modules(Deflect Deflect>=0.4)
  endif()
  if((NOT Deflect_FOUND) AND (NOT DEFLECT_FOUND))
    message(FATAL_ERROR "Could not find Deflect")
  endif()
else()
  find_package(Deflect 0.4  REQUIRED)
endif()
...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Qt4 4.6 COMPONENTS QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit QtDeclarative)
  if((NOT Qt4_FOUND) AND (NOT QT4_FOUND))
    pkg_check_modules(Qt4 Qt4>=4.6)
  endif()
  if((NOT Qt4_FOUND) AND (NOT QT4_FOUND))
    message(FATAL_ERROR "Could not find Qt4 COMPONENTS QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit QtDeclarative")
  endif()
else()
  find_package(Qt4 4.6  REQUIRED QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit QtDeclarative)
endif()
